...
use neko_ast::Span;
use neko_classic::{DecisionTree, KMeans, LogisticRegression, RandomForest};
use std::rc::Rc;

pub fn nml_kmeans(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nml_kmeans_predict(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nml_logistic_fit(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nml_decision_tree(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nml_random_forest(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
