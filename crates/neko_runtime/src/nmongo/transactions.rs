...
pub fn nmongo_start_session(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nmongo_start_transaction(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nmongo_commit_transaction(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nmongo_abort_transaction(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nmongo_end_session(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
