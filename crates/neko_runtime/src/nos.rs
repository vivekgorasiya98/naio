...
/// Script arguments passed after the file path on the CLI (`neko run app.neko a b`).
...
fn nos_getpid(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
    Ok(ok_int(process::id() as i64))
}

fn nos_getppid(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
    // Not available in std; return 0 when unsupported (Python raises on some platforms).
    Ok(ok_int(0))
}

fn nos_exit(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_system(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_argv(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
...
fn nos_getcwd(_args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_chdir(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_listdir(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_mkdir(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_makedirs(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_rmdir(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_remove(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_rename(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_lstat(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_cpu_count(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
...
fn nos_hostname(_args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_username(_args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nos_platform(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
    #[cfg(windows)]
...
fn nos_arch(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
