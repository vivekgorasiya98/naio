...
fn tokio_runtime() -> &'static tokio::runtime::Runtime {
    TOKIO_RUNTIME.get_or_init(|| {
        tokio::runtime::Builder::new_multi_thread()
            .enable_all()
            .thread_name("neko-async")
            .build()
            .expect("failed to create neko async tokio runtime")
    })
}
...
where
    ...
    F: FnOnce(&AsyncState) -> NekoResult<ValueRef>,
...
pub fn cancel_task(id: u64, span: Span, task_not_found_code: u32) -> NekoResult<bool> {
