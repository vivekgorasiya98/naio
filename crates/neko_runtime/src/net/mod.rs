...
pub type NetResult = NekoResult<ValueRef>;
...
pub(crate) fn arity(args: &[ValueRef], n: usize, name: &str, span: Span) -> NekoResult<()> {
    if args.len() != n {
...
pub(crate) fn string_arg(args: &[ValueRef], idx: usize, name: &str, span: Span) -> NekoResult<String> {
...
pub(crate) fn int_arg(args: &[ValueRef], idx: usize, name: &str, span: Span) -> NekoResult<i64> {
    match &*args[idx].borrow() {
        Value::Int(n) => Ok(*n),
        other => Err(type_err(
            span,
...
pub(crate) fn bool_arg(args: &[ValueRef], idx: usize, name: &str, span: Span) -> NekoResult<bool> {
    match &*args[idx].borrow() {
        Value::Bool(b) => Ok(*b),
        other => Err(type_err(
            span,
...
pub(crate) fn size_arg(args: &[ValueRef], idx: usize, name: &str, span: Span) -> NekoResult<usize> {
...
pub(crate) fn port_arg(args: &[ValueRef], idx: usize, name: &str, span: Span) -> NekoResult<u16> {
    let n = int_arg(args, idx, name, span)?;
...
pub(crate) fn handle_arg(args: &[ValueRef], idx: usize, name: &str, span: Span) -> NekoResult<u64> {
...
pub(crate) fn int_array_arg(args: &[ValueRef], idx: usize, name: &str, span: Span) -> NekoResult<Vec<u8>> {
    match &*args[idx].borrow() {
...
pub(crate) fn payload_arg(args: &[ValueRef], idx: usize, name: &str, span: Span) -> NekoResult<Vec<u8>> {
