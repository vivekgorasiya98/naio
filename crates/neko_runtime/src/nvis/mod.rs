...
fn nvis_line(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nvis_hist(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nvis_scatter(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nvis_heatmap(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nvis_bar(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nvis_save_svg(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nvis_print_ascii(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nvis_to_csv(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
