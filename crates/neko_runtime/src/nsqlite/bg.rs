...
fn capture_db_path(conn_id: u64, span: Span) -> NekoResult<String> {
...
pub fn nsqlite_async_exec(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nsqlite_async_query(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nsqlite_task_done(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nsqlite_task_wait(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nsqlite_task_result(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn nsqlite_task_cancel(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
