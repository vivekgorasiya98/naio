...
fn nsqlite_exec(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_exec_many(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_migrate(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_table_exists(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_list_tables(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_table_info(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_list_indexes(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_query(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_query_row(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_query_value(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_query_column(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_batch(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn nsqlite_insert(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
    ...
    for (k, v) in &data {
        ...
        params.push(types::neko_to_bound(&*v.borrow(), span)?);
    }
    let sql = format!(
        "INSERT INTO \"{}\" ({}) VALUES ({})",
        table.replace('"', "\"\""),
