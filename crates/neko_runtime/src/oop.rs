...
use neko_errors::{NekoResult, RuntimeError};
...
impl ClassRegistry {
    ...
    pub fn register_trait(&mut self, def: &TraitDef) -> NekoResult<()> {
    ...
    fn validate_implements(&self, class_def: &ClassDef, trait_name: &str) -> NekoResult<()> {
