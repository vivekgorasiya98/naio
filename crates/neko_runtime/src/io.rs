...
use crate::{error_value, NativeFn, NekoResult, RuntimeError, StringArray, Value, ValueRef};
use neko_ast::Span;
...
fn int_array_arg(args: &[ValueRef], idx: usize, name: &str, span: Span) -> NekoResult<Vec<u8>> {
    match &*args[idx].borrow() {
...
fn path_from_arg(args: &[ValueRef], idx: usize, name: &str, span: Span) -> NekoResult<PathBuf> {
    Ok(PathBuf::from(string_arg(args, idx, name, span)?))
}

fn io_join(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_join_many(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_dirname(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_basename(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_stem(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_extension(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_is_absolute(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
    arity(args, 1, "io_is_absolute", span)?;
    let path = path_from_arg(args, 0, "io_is_absolute", span)?;
    Ok(ok_bool(path.is_absolute()))
}

fn io_canonical(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_modified_ms(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_created_ms(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn io_read_file(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_read_bytes(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn io_write_file(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_write_bytes(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_append_file(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_read_lines(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_write_lines(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_list_dir(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_list_dir_recursive(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_create_dir(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_create_dir_all(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_remove_file(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_remove_dir(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_remove_dir_all(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_copy(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_rename(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_cwd(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_chdir(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_temp_dir(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_home_dir(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_open(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_close(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_read(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_read_all(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_read_line(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_write(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_flush(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_seek(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_tell(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_eof(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_async_read(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_async_read_bytes(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_async_write(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_async_write_bytes(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_async_copy(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_task_done(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_task_poll(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_task_wait(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn io_task_cancel(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
mod tests {
    ...
    fn io_roundtrip_text_file() {
        let dir = env::temp_dir().join("neko_io_test");
    ...
    fn io_async_read_completes() {
        let dir = env::temp_dir().join("neko_io_async_test");
        let _ = fs::remove_dir_all(&dir);
        fs::create_dir_all(&dir).unwrap();
