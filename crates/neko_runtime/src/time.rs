...
fn time_now_unix_ms(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
    Ok(ok_int(system_now_unix_ms()))
}

fn time_now_perf_us(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
    Ok(ok_int(perf_now_us()))
}

fn time_elapsed_ms(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_now_unix_s(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
    Ok(ok_int(system_now_unix_ms() / 1000))
}

fn time_now_iso(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
    let ms = system_now_unix_ms();
    let utc = ms_to_utc(ms).unwrap_or_else(Utc::now);
    Ok(ok_string(utc.to_rfc3339()))
}

fn time_now_iso_local(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
    let ms = system_now_unix_ms();
    let local = local_datetime(ms).unwrap_or_else(|_| Local::now());
    Ok(ok_string(local.to_rfc3339()))
}

fn time_now(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_format(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_parse(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_to_iso(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_decompose(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_from_parts(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_add_ms(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_add_seconds(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_add_minutes(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_add_hours(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_add_days(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_diff_ms(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_utc_offset_ms(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_is_leap_year(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_days_in_month(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_is_valid_date(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_start_of_day(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_end_of_day(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_sleep_ms(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_list_timezones(_args: &[ValueRef], _span: Span) -> NekoResult<ValueRef> {
...
fn time_year(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_month(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_day(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_hour(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_minute(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_second(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_weekday(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
fn time_weekday_name(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
