...
pub fn npg_pool(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn npg_pool_close(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn npg_pool_get(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
...
pub fn npg_pool_status(args: &[ValueRef], span: Span) -> NekoResult<ValueRef> {
