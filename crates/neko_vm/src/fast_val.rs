...
use neko_runtime::{apply_binop, apply_unaryop, RuntimeError, Value, ValueRef};
...
impl FastVal {
    ...
    #[inline(always)]
    pub fn from_const(c: &neko_bytecode::BytecodeConst, heap: &mut impl HeapAlloc) -> Self {
        match c {
            neko_bytecode::BytecodeConst::Int(v) => FastVal::Int(*v),
            neko_bytecode::BytecodeConst::Float(v) => FastVal::Float(*v),
            neko_bytecode::BytecodeConst::Bool(v) => FastVal::Bool(*v),
            neko_bytecode::BytecodeConst::Nil => FastVal::Nil,
            neko_bytecode::BytecodeConst::String(v) => {
