...
pub struct ProjectPackage {
    ...
    #[serde(default)]
    pub version: String,
    /// Required Neko toolchain version.
    #[serde(default)]
    pub neko: String,
    #[serde(default)]
...
/// Library package manifest in the Neko source tree (`neko_libs/<name>/package.json`).
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct LibPackage {
    ...
    /// Optional `.neko` sources relative to the version directory.
    #[serde(default)]
