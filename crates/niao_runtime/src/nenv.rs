...
fn nenv_get(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_set(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_unset(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_has(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity(args, 1, "nenv_has", span)?;
    let key = string_arg(args, 0, "nenv_has", span)?;
    Ok(ok_bool(env::var(&key).is_ok()))
}

fn nenv_all(_args: &[ValueRef], _span: Span) -> NiaoResult<ValueRef> {
    let mut map = HashMap::new();
    for (k, v) in env::vars() {
...
fn nenv_require(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_get_int(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_get_bool(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_get_float(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_load(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_load_many(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_load_defaults(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_parse(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_parse_text(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_expand(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity(args, 1, "nenv_expand", span)?;
    let text = string_arg(args, 0, "nenv_expand", span)?;
    Ok(ok_string(expand_text(&text)))
}

fn nenv_find_up(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_validate(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_open(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_close(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_store_get(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_store_set(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_store_unset(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_store_all(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_store_apply(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nenv_from_object(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
mod tests {
    ...
    #[test]
    fn expand_braced() {
        env::set_var("HOME", "/home/niao");
        assert_eq!(expand_text("${HOME}/data"), "/home/niao/data");
        env::remove_var("HOME");
    }
