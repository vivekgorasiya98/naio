...
use super::types::{bound_to_sql_params, niao_to_bound, rewrite_placeholders, sql_param_refs};
...
pub fn npg_prepare(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_bind(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_stmt_exec(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_stmt_query(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_stmt_reset(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_finalize(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
