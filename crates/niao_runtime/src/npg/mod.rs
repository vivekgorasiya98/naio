...
fn npg_exec(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn npg_migrate(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn npg_table_exists(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn npg_table_info(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn npg_list_indexes(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn npg_query(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn npg_query_column(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn npg_batch(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn query_table(
    ...
    let bound: Vec<types::BoundValue> = params
        .iter()
        .map(|p| types::niao_to_bound(&p.borrow(), span))
        .collect::<Result<_, _>>()?;
