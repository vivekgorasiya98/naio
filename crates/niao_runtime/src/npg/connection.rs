...
pub fn npg_connect(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_connect_opts(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_close(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_ping(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_configure(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_conninfo(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_server_version(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_commit(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_rollback(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_savepoint(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_rollback_to(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_version(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity(args, 0, "npg_version", span)?;
    Ok(ok_string(env!("CARGO_PKG_VERSION")))
}

pub fn npg_escape_literal(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_quote_ident(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
