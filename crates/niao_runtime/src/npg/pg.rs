...
pub fn npg_listen(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_unlisten(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_notify(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_poll_notify(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_advisory_lock(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_advisory_unlock(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_copy_from(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
