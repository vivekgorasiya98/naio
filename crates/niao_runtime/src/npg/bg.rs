...
fn capture_conninfo(conn_id: u64, span: Span) -> NiaoResult<String> {
...
pub fn npg_async_exec(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_async_query(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_task_done(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_task_wait(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_task_result(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn npg_task_cancel(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
