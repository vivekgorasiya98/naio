...
pub fn nsqlite_open(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_open_abs(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_close(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_configure(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_path(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_last_insert_rowid(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_changes(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_begin(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_commit(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_rollback(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_vacuum(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_version(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity(args, 0, "nsqlite_version", span)?;
    Ok(ok_string(rusqlite::version()))
}

pub fn nsqlite_backup(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
