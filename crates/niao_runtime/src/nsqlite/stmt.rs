...
use super::types::{apply_stmt_bindings, niao_to_bound};
...
pub fn nsqlite_prepare(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_bind(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_bind_named(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_stmt_exec(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_stmt_query(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_stmt_reset(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn nsqlite_finalize(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
