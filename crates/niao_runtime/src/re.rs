...
fn with_regex(
    ...
    name: &str,
    span: Span,
    f: impl FnOnce(&Regex) -> NiaoResult<ValueRef>,
) -> NiaoResult<ValueRef> {
    RE_HANDLES.with(|map| {
...
fn re_valid(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_close(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity(args, 1, "re_close", span)?;
    let id = handle_arg(args, 0, "re_close", span)?;
    Ok(Value::Bool(remove_regex(id)).ref_cell())
}

fn re_test(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_match(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_search(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_find_all(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_find_all_strings(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_replace(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_replace_n(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_count(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_test_h(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_search_h(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_find_all_h(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_find_all_strings_h(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_replace_h(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_replace_n_h(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_split_h(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn re_count_h(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
