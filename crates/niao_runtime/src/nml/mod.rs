//! NML — Niao Machine Learning (native builtins).
...
use niao_ml::layer::Layer;
use niao_ml::model::Sequential;
use niao_tensor::{global_device, set_global_device, Device, Tensor};
...
fn nml_set_device(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_device_count(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity(args, 0, "nml_device_count", span)?;
    let cuda = niao_tensor::cuda_device_count() as i64;
    Ok(ok_int(cuda))
}

fn nml_sync(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity(args, 0, "nml_sync", span)?;
    Ok(Value::Nil.ref_cell())
}

fn nml_zeros(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_ones(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_randn(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_tensor(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity(args, 2, "nml_tensor", span)?;
    let t = bridge::from_packed_float_array(args, span)?;
    Ok(ok_handle(alloc_handle(NmlHandle::Tensor(t))))
}

fn nml_from_ncl(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_to_float_array(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_shape(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_reshape(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_to_device(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_matmul(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_add(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    binary_op(args, span, "nml_add", |a, b| a.add(b))
}

fn nml_sub(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    binary_op(args, span, "nml_sub", |a, b| a.sub(b))
}

fn nml_mul(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    binary_op(args, span, "nml_mul", |a, b| a.mul(b))
}

fn nml_relu(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity(args, 1, "nml_relu", span)?;
    let id = nml_handle_arg(args, 0, "nml_relu", span)?;
    unary_op(id, span, "nml_relu", |t| t.relu())
}

fn nml_softmax(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_linear(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_relu_layer(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity(args, 0, "nml_relu_layer", span)?;
    let model = Sequential::new(vec![Layer::relu()], current_device());
    Ok(ok_handle(alloc_handle(NmlHandle::Model(model))))
}

fn nml_conv2d_layer(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_batch_norm2d(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_sequential(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_forward(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_conv2d(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn nml_dataloader(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn binary_op<F>(args: &[ValueRef], span: Span, name: &str, op: F) -> NiaoResult<ValueRef>
where
    F: Fn(&Tensor, &Tensor) -> Result<Tensor, niao_tensor::TensorError>,
{
...
fn unary_op<F>(id: u64, span: Span, name: &str, op: F) -> NiaoResult<ValueRef>
where
    F: Fn(&Tensor) -> Result<Tensor, niao_tensor::TensorError>,
{
