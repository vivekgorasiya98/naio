...
use super::app::{self, make_niao_handler};
use super::common::*;
...
fn ahiru_app_set_state(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_app_group(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_app_static(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_app_on_error(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    arity_range(args, 2, 2, "ahiru_app_on_error", span)?;
    let app_id = int_arg(args, 0, "ahiru_app_on_error", span)? as u64;
    let handler = make_niao_handler(args[1].clone(), span);
...
fn ahiru_app_not_found(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_app_init_cache(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_cache_get(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_cache_set(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_cache_incr(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_job_enqueue(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_app_cron(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    ...
    let handler = make_niao_handler(args[2].clone(), span);
...
fn ahiru_ws_broadcast(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_v3_mount_metrics(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_v3_mount_health(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
fn ahiru_app_resource(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
    ...
    let register = |key: &str, method: HttpMethod, path: &str| -> NiaoResult<()> {
        if let Some(h) = handlers.get(key) {
            let handler = make_niao_handler(h.clone(), span);
...
fn ahiru_db_query(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
...
pub fn ahiru_app_use_custom(args: &[ValueRef], span: Span) -> NiaoResult<ValueRef> {
