...
/// Build a Niao request object from a live HTTP context (interpreter / single-thread VM path).
pub fn ctx_to_niao(ctx: &mut RequestContext) -> ValueRef {
...
/// Build a Niao request object from flat pool-dispatch fields.
pub fn fields_to_niao(fields: &HashMap<String, String>) -> ValueRef {
...
#[cold]
#[allow(dead_code)]
pub fn ctx_to_niao_slow(ctx: &mut RequestContext) -> ValueRef {
    ctx_to_niao(ctx)
}
